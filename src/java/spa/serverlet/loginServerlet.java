	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			try {
				...
				boolean isAdmin = authenticate.validateAdmin();

				if (isAdmin == true) {

					ResultSet result = authenticate.getAdmin();
					...
					response.sendRedirect("Spa/Admin/index.jsp");

				} else {
					out.println("Invalid crenditials");
				}
