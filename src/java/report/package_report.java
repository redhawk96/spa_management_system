...
@WebServlet(name = "package_report", urlPatterns = {"/package_report"})
public class package_report extends HttpServlet {
	...
	//          String report_name = request.getParameter("report_name");
	            ...
	            if (Connect.getInstance() != null) {
	    			...
	    			String query = "SELECT client_id, spa_package, price FROM spa";
	                
	                String reportPath = "C:\\Users\\Dell\\eclipse-workspace\\TM\\WebContent\\Spa\\Admin\\Reports\\package_report_template.jrxml";
	                ...
	                JasperExportManager.exportReportToPdfFile(jasperPrint, "C:\\Users\\Dell\\eclipse-workspace\\TM\\WebContent\\Spa\\Admin\\Reports\\NewPackageReport.pdf");
